...
$prismal_theme_divider_style = array(
...
$prismal_title                         = 'Create Your Own Opportunities';
$prismal_subtitle                      = 'Lorem ipsum dolor sit amet, at mei dolore tritani repudiandae.<br>In his nemore temporibus consequuntur, vim ad prima vivendum.';
$prismal_theme_action_button           = 'Start Your Journey';
$prismal_theme_action_button_secondary =  'Contact us';

$defaults = array(
	'default_icon'                      => $prismal_theme_svg_icons['fort-awesome'],
	'icons'                             => $prismal_theme_svg_icons,
	'divider_style'                     => $prismal_theme_divider_style,
	'gradients'                         => $prismal_gradients,

	'assets_js_key'                     => 'kubioFrontendData',

	'edit_this_text_in_customizer'      => $prismal_title,
	'lorem_ipsum'                       => $prismal_subtitle,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $prismal_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $prismal_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'subtitle'     => array(
			'show'  => true,
			'value'      => $prismal_subtitle,
			'localProps' => array(
				'content' => $prismal_subtitle
			),
			'style' => array(
				'descendants' => array(
					'text' => array(
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $prismal_gradients['night_fade'],
									),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $prismal_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $prismal_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $prismal_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $prismal_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $prismal_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $prismal_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $prismal_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $prismal_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $prismal_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $prismal_theme_svg_icons['phone-square'],
	...
	'blog_post_thumb_placeholder_color' => 'rgba(187,206,215,1)',
