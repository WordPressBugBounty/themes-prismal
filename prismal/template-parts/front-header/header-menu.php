...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer prismal-front-header__k__c6BbujDIAOY-outer prismal-local-150-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
  ...
  'wrapper_class' => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row prismal-front-header__k__0xSC3AT64-container prismal-local--container',
  'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  prismal-front-header__k__0xSC3AT64-image prismal-local--image',
  'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   prismal-front-header__k__0xSC3AT64-alternateImage prismal-local--alternateImage',
  'logo_text_class' => 'position-relative wp-block-kubio-logo__text  prismal-front-header__k__0xSC3AT64-text prismal-local--text',
)); ?>
										</div>
									</div>
								</div>
